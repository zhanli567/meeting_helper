...
test('编辑人员弹窗工号只读并使用横向表格编辑记录和字段', async () => {
  ...
  assert.match(source, /scrollToNewestRecord/)
  assert.match(source, /canAddParticipantRecord/)
  assert.match(source, /createdInDialog:\s*true/)
  assert.match(source, /请先填写已新增记录的数据/)
